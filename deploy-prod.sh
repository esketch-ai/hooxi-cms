...
gcloud run deploy "$SERVICE" \
  ...
  --set-secrets="DATABASE_URL=hooxi-database-url:latest,JWT_SECRET=hooxi-jwt-secret:latest,ASSET_ENC_KEY=hooxi-asset-enc-key:latest,KAKAO_WEBHOOK_SECRET=hooxi-kakao-webhook-secret:latest,KAKAO_REST_API_KEY=hooxi-kakao-rest-api-key:latest" \
