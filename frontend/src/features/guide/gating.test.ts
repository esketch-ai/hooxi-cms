...
const EXPECTED_HIDDEN_IDS = [
  'observe', // 경영 관찰 — /observe는 재무 은닉 경로(Executive View 재설계)
  'tax-invoices', 'finance-ledger', 'asset-report', 'settlements', 'buyers', 'portal-accounts',
]
